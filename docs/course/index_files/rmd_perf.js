...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 2053 }, { marker: 'pandoc', elapsed: 117 }, { marker: 'post-processor', elapsed: 62 }, { marker: 'pre-processor', elapsed: 4 }, { marker: 'render', elapsed: 2460 } ];
