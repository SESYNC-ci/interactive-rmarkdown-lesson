...
Alternatively, the chunk interpreter can be set as python. Rmarkdown will assume that you have the [reticulate](https://rstudio.github.io/reticulate/articles/r_markdown.html) package installed unless the `python.reticulate` chunk argument is set to `FALSE`.
...
include_graphics('https://github.com/SESYNC-ci/interactive-rmarkdown-lesson/blob/master/docs/images/arrows3.png?raw=true')
```
